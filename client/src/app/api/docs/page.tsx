        ...
        <div className="flex flex-col">
            <main className="flex-1 flex flex-col items-center justify-center max-w-2xl mx-auto px-4">
                <Card className="w-full mt-8 mb-8">
                    <h1 className="text-3xl font-bold mb-4 text-yellow-400">Nomalos Public API</h1>
                    <p className="text-gray-200 mb-4">
                        Welcome to the Nomalos public API! All endpoints are available at:<br />
                        <span className="font-mono text-yellow-400">https://comingsoon.com/api/</span>
                    </p>
                    ...
                    <pre className="bg-[#232323] text-yellow-400 rounded p-3 mb-2 text-xs break-words">
